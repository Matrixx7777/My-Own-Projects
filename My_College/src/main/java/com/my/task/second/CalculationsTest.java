...
import com.my.test.java.task.second.Student;
...
public class CalculationsTest {
    ...
    public void findStudentsWhichSpeakPolishWithAverageFromMathAbove4() {
        ...
        //when
        var result = calculations.findStudentsWhichSpeakPolishWithAverageFromMathAbove4(entries);

        //then
        Assert.assertEquals(1, result.size());
        Assert.assertEquals("Los", result.get(0));
    }
}